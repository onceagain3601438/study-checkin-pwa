...
interface CalendarDay {
  ...
  hasRecord: boolean        // 是否有学习记录
  recordInfo: {
    hasCompleted: boolean   // 是否有完成的任务
    hasPartial: boolean     // 是否有部分完成的任务
    earnedPoints: number    // 当天获得的积分
...
Page({
   ...
   * 检查学习记录
   */
  checkStudyRecord(dateString: string) {
    try {
